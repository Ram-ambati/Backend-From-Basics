...
export const chapters = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        slug: 'http-protocol',
        concepts: [
          'HOPS', 'HTTP Raw Message', 'Headers', 'Methods',
          'CORS', 'Preflight', 'Structure', 'Status Codes',
          'Caching', 'HTTP 1.1', 'HTTP 2.0', 'HTTP 3.0',
          'Content Negotiation', 'Persistent Connections',
          'Compression Types',
        ],
        status: 'empty',
      },
